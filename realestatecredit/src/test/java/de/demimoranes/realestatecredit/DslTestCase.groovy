...
class DslTestCase extends GroovyTestCase {
	...
	public void testMietPruefung2() {
		...
		assert !result // nicht angemessen
	}
	
	@Test
	public void testEinkuenfteRentner() {
	...
	@Test
	public void testEinkuenftePensionaer() {
		Object result = runDsl("einkuenfte.formel",
			[
				monatlichesBruttoeinkommen: 0.0,
				Steuern: 350.0,
	...
	@Test
	public void testEinkuenfteStudent() {
		Object result = runDsl("einkuenfte.formel",
			[
	...
	@Test
	public void testEinkuenfteAngestellter() {
		Object result = runDsl("einkuenfte.formel",
			[
				monatlichesBruttoeinkommen: 2300.0,
				Steuern: 210.0,
	...
	@Test
	public void testEinkuenfteBeamter() {
		Object result = runDsl("einkuenfte.formel",
			[
				monatlichesBruttoeinkommen: 2300.0,
				Steuern: 210.0,
		...
		assert result == 1630.0
	}
	
	def runDsl(String scriptName, Map p) {
		Binding b = new Binding(p)
		
		CompilerConfiguration cc = new CompilerConfiguration(scriptBaseClass: DslDefinition.class.name)
